              ...
              {measurements.map((item) => (
                <MeasurementCard
                  ...
                  item={{
                    ...
                    electrodes: [
                      {
                        impedance: item.impedance_1,
                        phaseAngle: item.phase_angle_1,
                      },
                      {
                        impedance: item.impedance_2,
                        phaseAngle: item.phase_angle_2,
                      },
                      {
                        impedance: item.impedance_3,
                        phaseAngle: item.phase_angle_3,
                      },
                    ],
                  }}
                />
